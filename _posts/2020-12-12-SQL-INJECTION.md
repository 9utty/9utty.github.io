...
악의적인 사용자가 보안상 취약점을 이용해서, 임의의 SQL 문을 주입하고 실행되게 해서 데이터베이스가 비정상적인 동작을 하도록 조장하는 행위이다. 인젝션 공격은 OWASP Top10 중 첫 번째에 속해 있으며, 공격이 비교적 쉬운 편이고 공격에 성공할 경우 큰 피해를 입힐 수 있는 공격이다.

## SQL INJECTIO 공격 종류 및 방법
